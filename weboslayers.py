...
('meta-qt6',                  20, 'git://code.qt.io/yocto/meta-qt6.git',                    'branch=6.2,commit=6ce601a', ''),
...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=c7557cef', ''),
