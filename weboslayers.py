...
('meta-qt6',                  20, 'git://code.qt.io/yocto/meta-qt6.git',                    'branch=6.2,commit=b015158', ''),
...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=c665af4d', ''),
