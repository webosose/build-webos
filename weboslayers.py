...
('meta-qt6',                  20, 'https://code.qt.io/yocto/meta-qt6.git',                  'branch=6.8.0,commit=v6.8.0', ''),
...
('meta-webos',                40, 'https://github.com/webosose/meta-webosose.git',          'branch=master,commit=ba36e593e2', ''),
