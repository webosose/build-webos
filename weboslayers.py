...
('meta-qt5',                  20, 'git://github.com/meta-qt5/meta-qt5.git',                 'branch=thud,commit=1520d5b2', ''),
...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=11080b8', ''),
