...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=kirkstone,commit=c728c3f', ''),
...
('meta-webos',                40, 'https://github.com/webosose/meta-webosose.git',          'branch=master,commit=c5f2d212b', ''),
