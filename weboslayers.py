...
('meta-qt6',                  20, 'git://code.qt.io/yocto/meta-qt6.git',                    'branch=6.2,commit=b123055', ''),
...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=f71f9b017', ''),
